...
public class OpenStringBuilder implements CharSequence, Appendable, Serializable, Builder<String> {
    ...
    /**
     * Append a string in a fast manner without memory waste
     * 
     * @param src the source
     * @return this string builder
     */
    public OpenStringBuilder fastAppend(final String src)
    {
     ...
     * @return this, to enable chaining
     */
    public OpenStringBuilder deleteAll(final StringMatcher matcher) {
     ...
     * @return this, to enable chaining
     */
    public OpenStringBuilder deleteFirst(final StringMatcher matcher) {
        return replace(matcher, null, 0, size, 1);
    }
     ...
     * @return this, to enable chaining
     */
    public OpenStringBuilder replaceAll(final StringMatcher matcher, final String replaceStr) {
     ...
     * @return this, to enable chaining
     */
    public OpenStringBuilder replaceFirst(final StringMatcher matcher, final String replaceStr) {
        return replace(matcher, replaceStr, 0, size, 1);
    }
     ...
     */
    public OpenStringBuilder replace(final StringMatcher matcher, final String replaceStr, final int startIndex,
     ...
     *             if any index is invalid
     */
    private OpenStringBuilder replaceImpl(final StringMatcher matcher, final String replaceStr, final int from, int to,
            int replaceCount) {
