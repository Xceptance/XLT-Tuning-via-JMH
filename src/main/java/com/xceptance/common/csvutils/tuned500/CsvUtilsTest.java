package com.xceptance.common.csvutils.tuned500;
...
public class CsvUtilsTest
{
    ...
    {
        Assert.assertArrayEquals(NORMAL_DEC, CsvUtils.decode(NORMAL_ENC).toArray());
    }
    @Test
    public void testDecodeEmpty()
    {
        Assert.assertArrayEquals(EMPTY_DEC, CsvUtils.decode(EMPTY_ENC).toArray());
    }
    @Test
    public void testDecodeEmptyFields()
    {
        Assert.assertArrayEquals(EMPTY_FIELDS_DEC, CsvUtils.decode(EMPTY_FIELDS_ENC).toArray());
    }
    @Test
    public void testDecodeWhiteSpace()
    {
        Assert.assertArrayEquals(WHITESPACE_DEC, CsvUtils.decode(WHITESPACE_ENC).toArray());
    }
    @Test
    public void testDecodeDoubleQuote()
    {
        Assert.assertArrayEquals(DOUBLE_QUOTE_DEC, CsvUtils.decode(DOUBLE_QUOTE_ENC).toArray());
    }
    @Test
    public void testDecodeQuotedComma()
    {
        Assert.assertArrayEquals(COMMA_DEC, CsvUtils.decode(COMMA_ENC).toArray());
    }
