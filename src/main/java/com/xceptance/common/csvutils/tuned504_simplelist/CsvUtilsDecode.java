package com.xceptance.common.csvutils.tuned504_simplelist;
...
public final class CsvUtilsDecode
{
     ...
     */
    public static SimpleArrayList<String> parse(final String s)
    {
     ...
     */
    public static SimpleArrayList<String> parse(final char[] src, final char fieldSeparator)
    {
