package com.xceptance.common.csvutils.tuned513_labels_string;
...
public final class CsvUtilsDecode
{
    ...
    {
        final SimpleArrayList<String> result = new SimpleArrayList<>(30);
        ...
        while (pos < size)
        {
            ...
            if (c == QUOTE_CHAR)
            {
                ...
                while (pos < size)
                {
                    ...
                    if (c2 == QUOTE_CHAR)
                    {
                        ...
                        // peak
                        final char peakedChar = pos < size - 1 ? src[pos + 1] : 0;
                        if (peakedChar == 0)
                        {
            ...
            if (c == fieldSeparator)
            {
                ...
                // we need the data
                result.add(String.valueOf(src, start, offset - start));
