package com.xceptance.common.csvutils.tuned502;
...
public final class CsvUtils
{
     ...
     */
    public static String[] split(final String s, final char fieldSeparator)
    {
        ...
        final String[] target = new String[32];
        ...
        for (int i = 0; i < length; i++)
        {
            ...
            if (c == fieldSeparator)
            {
                ...
                {
                    target[targetPos++] = new String(src, beginIndex, i - beginIndex);
                    beginIndex = i + 1;
                }
            }
        ...
        // add the last field
        target[targetPos++] = new String(src, beginIndex, length - beginIndex);
