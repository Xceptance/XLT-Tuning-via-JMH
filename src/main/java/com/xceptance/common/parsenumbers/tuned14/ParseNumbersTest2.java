 ...
 */
public class ParseNumbersTest2
{
    /**
     * Test method for {@link com.xceptance.common.ParseNumbers.FastParseNumbersIfDigit#fastparseLong2(java.lang.String)}.
     */
    @Test
    public final void testparseLong2()
    {
        {
            final String s = "1670036109465868";
            Assert.assertEquals((long) Long.valueOf(s), ParseNumbers.parseLong2(XltCharBuffer.valueOf(s)));
        }
        {
            final String s = "0";
            Assert.assertEquals((long) Long.valueOf(s), ParseNumbers.parseLong2(XltCharBuffer.valueOf(s)));
     ...
     */
    @Test
    public final void testparseLong2Fallback()
    {
        {
            final String s = "-1670036109465868";
            Assert.assertEquals((long) Long.valueOf(s), ParseNumbers.parseLong2(XltCharBuffer.valueOf(s)));
    ...
    {
        final String s = "";
        ParseNumbers.parseLong2(XltCharBuffer.valueOf(s));
    }
